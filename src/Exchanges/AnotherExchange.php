...
/**
 * This exchange is exact replica of Europe Exchange, I have added this just to elaborate switching between exchanges
 *
 * Class AnotherExchange
 * @package Opeepl\BackendTest\Exchanges
 */
class AnotherExchange implements IExchange
{
